...
{
    /// <summary>
    /// class ["Assembly-CSharp.dll"."DataAsset"."TechnologyConfigDataManager"]
    /// [DataAsset.BaseConfigDataManager<DataAsset.TechnologyConfigData>]=>[UnityEngine.ScriptableObject]=>[UnityEngine.Object]=>[System.Object]
    /// </summary>
    [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassParentMetadataAttribute<Maple.MonoGameAssistant.MetadataExtensions.MetadataCollector.ClassMetadataCollector<Ptr_TechnologyConfigDataManager>, Ptr_TechnologyConfigDataManager>]
    [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassModelMetadataAttribute("Assembly-CSharp.dll", "DataAsset", "TechnologyConfigDataManager", "DataAsset.TechnologyConfigDataManager")]
    public partial class TechnologyConfigDataManager
    {
        [System.Runtime.InteropServices.StructLayoutAttribute(System.Runtime.InteropServices.LayoutKind.Sequential)]
        public unsafe readonly partial struct Ptr_TechnologyConfigDataManager(System.IntPtr ptr) : Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.IPtrMetadata
        {
            [System.Runtime.InteropServices.MarshalAsAttribute(System.Runtime.InteropServices.UnmanagedType.SysInt)]
            readonly System.IntPtr m_Pointer = ptr;
            public System.IntPtr Ptr => m_Pointer;

            public static implicit operator Ptr_TechnologyConfigDataManager(System.IntPtr ptr) => new Ptr_TechnologyConfigDataManager(ptr);
            public static implicit operator System.IntPtr(Ptr_TechnologyConfigDataManager ptr) => ptr.m_Pointer;
            public static implicit operator bool (Ptr_TechnologyConfigDataManager ptr) => ptr.m_Pointer != System.IntPtr.Zero;
        }

        /// <summary>
        /// class ["Assembly-CSharp.dll"."DataAsset"."TechnologyConfigDataManager"]
        /// </summary>
        partial struct Ptr_TechnologyConfigDataManager
        {
            /// <summary>
...
*/
            ...
            /// <summary>
            /// 0x18 System.Collections.Generic.List<DataAsset.TechnologyConfigData> datas
            /// class ["mscorlib.dll"."System.Collections.Generic"."List`1"]
            /// </summary>
            /// <returns>class System.Collections.Generic.List<DataAsset.TechnologyConfigData></returns>
             /*
            [Maple.MonoGameAssistant.MetadataExtensions.MetadataGenerator.ClassPropertyMetadataAttribute("datas", "System.Collections.Generic.List<DataAsset.TechnologyConfigData>")]
